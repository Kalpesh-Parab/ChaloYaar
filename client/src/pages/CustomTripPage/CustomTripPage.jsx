        ...
        <div className='site-container'>
          ...
          <div className='text-center max-w-3xl mx-auto mb-14 space-y-3'>
            ...
            <p className='font-sans text-coal-800 text-sm sm:text-base max-w-xl mx-auto'>
              College reunions, office offsites, ya doston ka secret trip. No
              tour-guide lecture—just private luxury travel with raw mountain
              vibes.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-20'>
            ...
            <div className='lg:col-span-7 rounded-surface yellow-card border border-coal-950/15 p-6 sm:p-10 shadow-xl bg-white'>
              <div className='mb-8'>
                <span className='font-calligraphy text-2xl text-coal-950'>
                  Quick Details Drop Karo
                </span>
                <h3 className='font-sans font-bold text-2xl text-coal-950'>
                  ...
                  <div className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                    {vibes.map((v) => (
                      <button
                        ...
                        key={v.id}
                        onClick={() =>
                          setFormData({ ...formData, vibe: v.label })
                        }
